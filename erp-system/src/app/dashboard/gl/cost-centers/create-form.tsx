...
import { createCostCenter } from '@/app/dashboard/gl/cost-centers/actions';
import { CostCenter } from '@prisma/client';

export default function CreateCostCenterForm({ costCenters }: { costCenters: CostCenter[] }) {
  const initialState = { message: null, errors: {} };
  const [state, dispatch] = useFormState(createCostCenter, initialState);
